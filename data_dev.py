...
class dataSYSTEM(HBSYSTEM):

    def __init__(self, _name, _config, _report):
        HBSYSTEM.__init__(self, _name, _config, _report)
        
    def dmrd_received(self, _peer_id, _rf_src, _dst_id, _seq, _slot, _call_type, _frame_type, _dtype_vseq, _stream_id, _data):
        print(_rf_src, _stream_id, _seq, _slot, _call_type, _frame_type, _dtype_vseq)
...
if __name__ == '__main__':
    ...
    def sig_handler(_signal, _frame):
        logger.info('SHUTDOWN: DATA APP IS TERMINATING WITH SIGNAL %s', str(_signal))
    ...
    logger.info('HBlink \'data_dev.py\' -- SYSTEM STARTING...')
